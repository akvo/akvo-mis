const uiText = {
  en: {
    ...
    savedToDeviceText:
      'Saved to this device. It will be stored properly next time you open the app.',
    ...
    mandatoryQuestionsWarning: 'Warning: Some mandatory questions are not answered yet',
    ...
    buttonDrawOnMap: 'Draw on map',
    syncRejectedText: 'Some submissions were returned to drafts. Please check the answers.',
    inputMethodTitle: 'Input method',
    inputMethodTapping: 'Placement by tapping',
    inputMethodManual: 'Manual location recording',
    inputMethodAutomatic: 'Automatic location recording',
    inputMethodComingSoon: 'Coming soon',
    buttonStart: 'Start',
    accuracyLabel: 'Accuracy',
    pointsEntered: 'Points entered',
    buttonUndo: 'Undo',
    buttonClear: 'Clear',
    buttonCentreOnMe: 'Centre on me',
    buttonSavePolygon: 'Save shape',
  ...
  fr: {
    ...
    mandatoryQuestions: 'Veuillez répondre à toutes les questions obligatoires',
    mandatoryQuestionsWarning:
      'Attention: Certaines questions obligatoires ne sont pas encore répondues',
    completeAllRequiredFields:
      'Veuillez remplir tous les champs obligatoires de toutes les sections avant de soumettre',
    ...
    buttonDrawOnMap: 'Dessiner sur la carte',
    syncRejectedText: 'Des soumissions sont repassees en brouillon. Verifiez les reponses.',
    inputMethodTitle: 'Methode de saisie',
    inputMethodTapping: 'Placement par appui',
    inputMethodManual: 'Enregistrement manuel de la position',
    inputMethodAutomatic: 'Enregistrement automatique de la position',
    inputMethodComingSoon: 'Bientot disponible',
    buttonStart: 'Demarrer',
    accuracyLabel: 'Precision',
    pointsEntered: 'Points saisis',
    buttonUndo: 'Annuler',
    buttonClear: 'Effacer',
    buttonCentreOnMe: 'Me centrer',
    buttonSavePolygon: 'Enregistrer la forme',
    polygonPoints: 'Points',
    polygonArea: 'Superficie',
