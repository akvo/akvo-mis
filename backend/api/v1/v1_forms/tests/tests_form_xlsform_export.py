...
class FormXLSFormExportEndpointTestCase(TestCase):
    ...
    def test_generate_administration_csv_max_level_capping(self):
        ...
        # Levels present in DB
        # Seeded administration levels:
        # level 0 (National), level 1 (Province), level 2 (District), etc.
        # With max_level=0, only level 0 administrations should be in CSV
        level_0_ids = set(
    ...
    def test_generate_administration_csv_multiple_cascade_takes_highest_max(
        ...
        # max(0, 1) = 1,
        # so Level 0 and Level 1 should be included, Level > 1 excluded
        level_1_ids = set(
