...
[[ "${CI_BRANCH}" != "tenant/mohhs-mis" ]] && { echo "Branch is not tenant/mohhs-mis. Skip deploy."; exit 0; }
[[ "${CI_PULL_REQUEST}" == "true" ]] && { echo "Pull request. Skip deploy."; exit 0; }

NAMESPACE="mohhs-mis-namespace"
IMAGE_PREFIX="eu.gcr.io/akvo-lumen/mohhs-mis"
